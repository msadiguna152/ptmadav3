        ...
        <div class="col-md-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Form Edit Data Pemasukan</b></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                ...
                ?>
                <form method="POST" action="<?php echo base_url('Finansial/proses_edit_pemasukan/' . $data['id_pembayaran']) ?>" enctype="multipart/form-data">
                  <div class="col-md-6">

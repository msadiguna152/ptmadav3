...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url('Finansial/index') ?>"><i class="fa fa-dashboard"></i>Finansial</a></li>
        ...
        <div class="row">
          <div class="col-lg-4 col-xs-12">
            ...
            <div class="small-box bg-aqua">
              ...
              <a href="<?php echo base_url('Finansial/lihat_permohonan') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-xs-12">
            ...
            <div class="small-box bg-green">
              ...
              <a href="<?php echo base_url('Finansial/lihat_tarif') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-xs-12">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-xs-12">
            ...
            <div class="small-box bg-blue">
              ...
              <a href="<?php echo base_url('Finansial/laporan_pemasukan') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-xs-12">
            ...
            <div class="small-box bg-red">
              ...
              <a href="<?php echo base_url('Finansial/laporan_pengeluaran') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
           <!-- ./col -->

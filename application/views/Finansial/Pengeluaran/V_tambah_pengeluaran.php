        ...
        <div class="col-md-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Form Data Pengeluaran</b></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                ...
                ?>
                <form method="POST" action="<?php echo base_url('Finansial/proses_tambah_pengeluaran/' . $id) ?>" enctype="multipart/form-data">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                  <div class="form-group">
                      <label for="exampleInputPassword1">IJP Jamkrida</label>
                      <input type="text" class="form-control" placeholder="Jumlahtagihan" required="" readonly value="<?php echo number_format($ijpjmk, 0, ',', '.'); ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Kontra Garansi Bank</label>
                      <input type="text" class="form-control" readonly value="<?php echo number_format($kontra, 0, ',', '.'); ?>">
                    </div>
                    <div class="form-group">

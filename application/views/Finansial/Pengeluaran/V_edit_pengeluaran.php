        ...
        <div class="col-md-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Form Edit Data Pengeluaran</b></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                ...
                ?>
                <form method="POST" action="<?php echo base_url('Finansial/proses_edit_pengeluaran/' . $data['id_pembayaran']) ?>" enctype="multipart/form-data">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group date">
                        ...
                        <input type="date" name="tgl_pembayaran" class="form-control" required value="<?php echo $data['tgl_pembayaran'] ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Uraian</label>
                      <input type="text" name="uraian" class="form-control" placeholder="Uraian" required="" autofocus value="<?php echo $data['uraian'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Jumlah</label>
                      <input type="number" name="jml_pembayaran" id="jml_pembayaran" class="form-control" placeholder="Jumlah" required="" value="<?php echo $data['jml_pembayaran'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Bukti</label>
                      <input type="text" name="bukti_lama" class="form-control" value="<?php echo $data['bukti_pembayaran'] ?>">
                      <input type="file" name="bukti_pembayaran" class="form-control">
                    </div>
                    <div class="form-group">
                      <input type="hidden" name="id_permohonan" class="form-control" value="<?php echo $data['id_permohonan'] ?>" required="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="box-footer">
              ...
              <a href="<?php echo base_url('Finansial/detail_permohonan/' . $data['id_permohonan'] . '/detail') ?>"><button type="button" class="btn btn-danger">Cancel</button></a>
            </div>

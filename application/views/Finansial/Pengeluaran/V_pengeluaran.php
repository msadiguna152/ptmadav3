<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Laporan Pengeluaran Permohonan
            <!-- <small>Rekanan</small> -->
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('Finansial/') ?>"><i class="fa fa-dashboard"></i> Finansial</a></li>
            <li class="active">Laporan Pengeluaran Permohonan</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Laporan Pengeluaran Permohonan</h3><br>
                    </div>
                            ...
                            <div class="col-md-8">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form id="form-filter" class="form-horizontal" method="POST" action="<?php echo base_url('Finansial/master_pengeluaran') ?>">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form id="form-filter" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-6  control-label">Jumlah Pemb. Pengeluaran</label>
                                                <div class="col-sm-6">
                                                    <input type="text" name="pemasukan" id="pemasukan" class="form-control" readonly value="<?php echo "Rp." . number_format($jml_byr, 0, ',', '.'); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-6    control-label">Jumlah Sisa Pemb. Pengeluaran</label>
                                                <div class="col-sm-6">
                            ...
                            <table id="data" class="table table-bordered table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Jumlah Pemb. Pengeluaran</th>
                                        <th>Sisa Pemb. Pengeluaran</th>

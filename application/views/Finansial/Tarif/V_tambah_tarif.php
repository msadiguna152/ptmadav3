<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Data Tarif</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Tambah Data Tarif</h3><br>
          </div>
          ...
          <div class="box-body">
            <div>
              <form method="POST" action="<?php echo base_url('Finansial/proses_tambah_tarif') ?>" enctype="multipart/form-data">
            ...
            <div>
              ...
              <table class="table table-striped" onload="sum();">
                ...
                <tr>
                  ...
                  <td><input type="text" name="biaya_materai_agent" id="biaya_materai_agent" class="form-control" value="<?php echo $biaya_materai_agent; ?>" autocomplete="off" onkeyup="sum();"></td>
                  <td>Rupiah</td>
                ...
                <tr>
                  ...
                  <td>
                  <input type="text" class="form-control" id="service_agent" value="" readonly>
                    <input type="hidden" class="form-control" name="service_agent" id="service_agent_post" value="" readonly>
                  </td>
                  <td></td>
                  <td>Diskon</td>
                  <td><input type="text" name="diskon" id="diskon" class="form-control" autocomplete="off" value="0" onkeyup="sum();"></td>
                  <td>Persen</td>
                </tr>
                <tr>
                  <td>Service Charge Jamkrida</td>
                  <td>
                  <input type="text" class="form-control" id="service_jamkrida" readonly>
                ...
                <tr>
                  <td>(Service Charge Agen)</td>
                  <td>
                  <input type="text" class="form-control" id="service_agent2" readonly>
                ...
                <td>(Service Charge Jamkrida)</td>
                  <td>
                    <input type="text" class="form-control" id="service_jamkrida2" readonly>
              ...
              <table class="table table-striped">
                <tr>
                  <th>IJP AGENT </th>
                  <td>
                    <input type="text" class="form-control" id="ijpagent" readonly>
                    <input type="hidden" class="form-control" name="ijpagent" id="ijpagent_post" readonly>
                  </td>
                  <td></td>
                  <th>IJP JAMKRIDA</th>
                  <td>
                    <input type="text" class="form-control" id="ijpjamkrida" readonly>
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" class="form-control" id="garansi_bank" readonly>
                    <input type="hidden" class="form-control" name="garansi_bank" id="garansi_bank_post" readonly>
                  </td>
                  <td></td>
                  <th>KONTRA GARANSI BANK</th>
                  <td>
                    <input type="text" class="form-control" id="garansi_bankcpy" readonly>
                  </td>
                  <td></td>
                </tr>
                <tr>
                  ...
                  <th>NILAI DISKON</th>
                  <td>
                    <input type="text" class="form-control" id="nilaidiskon" readonly>
                    <input type="hidden" class="form-control" name="nilaidiskon" id="nilaidiskon_post" readonly>
                  </td>
                  <td></td>
                  <th>TOTAL PENGELUARAN</th>
                  <td>
                    <input type="text" class="form-control" id="total_biaya2" readonly>
              ...
              <table class="table table-striped">
                <tr>
                  <th>PROFIT</th>
                  <td class="col-md-3">
                    <input type="text" class="form-control" id="saldo" style="margin-left: -175px;" readonly>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('Finansial/lihat_permohonan') ?>"><button type="button" class="btn btn-danger">Cancel</button></a>
              </div>
              </form>
            </div>

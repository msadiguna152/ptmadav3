<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Detail Data Tarif</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Detail Data Tarif</h3><br>
          </div>
          ...
          <div class="box-body">
            <div>
              <form method="POST" action="<?php echo base_url('Finansial/proses_edit_tarif/' . $id_tarif) ?>" enctype="multipart/form-data">
            ...
            <div>
              ...
              <table class="table table-striped" onload="sum();">
                <tr>
                  ...
                  <td><input type="text" name="trf_min_bank" id="trf_min_bank" class="form-control" value="<?php echo $trf_min_bank; ?>" autocomplete="off" onkeyup="sum();" readonly></td>
                  <th></th>
                </tr>
                <tr>
                  <td>Nilai Proyek</td>
                  ...
                  <td><input type="text" name="trf_maxbulan" id="trf_maxbulan" class="form-control" value="<?php echo $trf_maxbulan; ?>" autocomplete="off" onkeyup="sum();" readonly></td>
                  <td></td>
                </tr>
                <tr>
                  ...
                  <td><input type="text" name="trf_enambulan" id="trf_enambulan" class="form-control" value="<?php echo $trf_enambulan; ?>" autocomplete="off" onkeyup="sum();" readonly></td>
                  <td></td>
                </tr>
                <tr>
              ...
              <div class="box-footer">
                <a href="<?php echo base_url('Finansial/ubah_tarif/' . $id_tarif) ?>"><button type="button" class="btn btn-primary">Edit Tarif</button></a>
                <a href="<?php echo base_url('Finansial/lihat_tarif') ?>"><button type="button" class="btn btn-danger">Cancel</button></a>
              </div>
              </form>
            </div>

          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <form method="POST" action="<?php echo base_url('Ptmada/proses_edit_pejabat') ?>" enctype="multipart/form-data">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="alamat" class="form-control" placeholder="Alamat" value="<?php echo $data['alamat'] ?>" autocomplete="off"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" maxlength="13" onkeypress="return hanyaAngka(event)" name="no_telp" class="form-control" placeholder="Nomor Telpon" value="<?php echo $data['no_telp'] ?>" autocomplete="off">
                    </div>

          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <form method="POST" action="<?php echo base_url('Ptmada/proses_tambah_dokumen') ?>" enctype="multipart/form-data">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="dokumen" placeholder="Nama Dokumen" required=" " autofocus autocomplete="off" required="">
                    </div>

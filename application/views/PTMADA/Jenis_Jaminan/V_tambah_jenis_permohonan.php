        ...
        <div class="col-md-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">TAMBAH DATA JENIS PERMOHONAN</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">

                <form method="POST" action="<?php echo base_url('Ptmada/proses_tambah_jenis_permohonan') ?>" enctype="multipart/form-data">
                  <div class="col-md-6">

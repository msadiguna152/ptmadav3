          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <form method="POST" action="<?php echo base_url('Ptmada/proses_tambah_pembayaran_jamkridaw') ?>" enctype="multipart/form-data">
                  <div class="col-md-6">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('Ptmada/detail_permohonan/' . $id_permohonan) ?>"><button type="button" class="btn btn-danger">Cancel</button></a>
              </div>

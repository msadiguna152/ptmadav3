<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php base_url() ?>/ptmada/Ptmada/lihat_permohonan">Permohonan</a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="pembayaran">
              <div class="row no-print" style="margin-bottom: 30px;">
                <div class="col-xs-12">
                  <a href="<?php echo base_url('Ptmada/tambah_pembayaran/' . $dt['id_permohonan']) ?>" class="btn btn-primary " title="Tambah Data Pembayaran"><i class="fa fa-plus"></i> Pembayaran</a>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo site_url('Ptmada/edit_pembayaran/' . $td['id_pembayaran']); ?>" title="Edit"><i class="fa fa-edit"></i></a>
                        |
                        <a href="<?php echo site_url('Ptmada/hapus_pembayaran/' . $td['id_pembayaran'] . '/' . $td['id_permohonan']); ?>" onclick="return konformasi()" title="Hapus"><i class="fa fa-trash"></i></a>
                      </td>
            ...
            <div class="tab-pane" id="jamkrida">
              <div class="row no-print" style="margin-bottom: 30px;">
                <div class="col-xs-12">
                  <a href="<?php echo base_url('Ptmada/tambah_pembayaran_jamkrida/' . $dt['id_permohonan']) ?>" class="btn btn-primary " title="Tambah Data Pembayaran Jamkrida"><i class="fa fa-plus"></i> Pembayaran</a>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <!-- <td><?php echo $dt['jenis_jaminan']; ?></td> -->
                      <td>
                        <a href="<?php echo site_url('Ptmada/edit_pembayaran_jamkrida/' . $td['id_pembayaran']); ?>" title="Edit"><i class="fa fa-edit"></i></a>
                        |
                        <a href="<?php echo site_url('Ptmada/hapus_pembayaran_jamkrida/' . $td['id_pembayaran'] . '/' . $td['id_permohonan']); ?>" onclick="return konformasi()" title="Hapus"><i class="fa fa-trash"></i></a>
                      </td>
...
<!-- ANCHOR begin sertifikat -->
            ...
            <div class="row no-print" style="margin-bottom: 30px;">
                <div class="col-xs-12">
                  <a href="<?php echo base_url('Ptmada/tambah_sertifikat/' . $dt['id_permohonan']) ?>" class="btn btn-primary " title="Tambah Data Sertifikat"><i class="fa fa-plus"></i> Sertifikat</a>
                </div>
              </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo site_url('Ptmada/edit_sertifikat/' . $td['id_pembayaran']); ?>" title="Edit"><i class="fa fa-edit"></i></a>
                        |
                        <a href="<?php echo site_url('Ptmada/hapus_sertifikat/' . $td['id_pembayaran'] . '/' . $td['id_permohonan']); ?>" onclick="return konformasi()" title="Hapus"><i class="fa fa-trash"></i></a>
                      </td>

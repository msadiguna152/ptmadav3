          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <form method="POST" action="<?php echo base_url('Admin/proses_edit_sertifikat') ?>" enctype="multipart/form-data">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputPassword1">File Sertifikat</label>
                      <input type="hidden" name="sertifikat_lama" class="form-control" value="<?php /*echo $dt['bukti_pembayaran']*/ ?>" required="">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('Admin/detail_permohonan/' . $dt['id_permohonan']) ?>"><button type="button" class="btn btn-danger">Cancel</button></a>
              </div>

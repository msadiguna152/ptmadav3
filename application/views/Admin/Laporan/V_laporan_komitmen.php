      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-footer">
            <a href="<?php echo base_url('Admin/cetak_laporan_komitmen') ?>"><button type="button" class="btn btn-info" title="Tambah Data Pejabat"><i class="fa fa-print"></i> Cetak</button></a>
          </div>
          <!-- /.box-header -->
          <div class="box-body">

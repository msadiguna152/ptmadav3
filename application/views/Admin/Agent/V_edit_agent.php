        ...
        <div class="col-md-12">
          <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">FORM EDIT DATA Agent</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">

                <form method="POST" action="<?php echo base_url('Admin/proses_edit_agent') ?>" enctype="multipart/form-data">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="alamat" class="form-control" placeholder="Alamat" required="" value="<?php echo $data['alamat'] ?>">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="no_telp" class="form-control" placeholder="Nomor Telpon" required="" value="<?php echo $data['no_telp'] ?>">
                    </div>
                  </div>
              </div>
              <!-- /.row -->

<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php base_url() ?>/Admin/Admin/lihat_instansi">Instansi</a></li>
          ...
          <div class="tab-content">
            <div class="active tab-pane" id="profilpejabat">
              ...
              <div class="card-body">
                ...
                <a href="<?php echo site_url('Admin/edit_instansi/' . $data['id_instansi']); ?>"><button class="btn btn-success"><i class="fa fa-edit"></i> Edit</button></a>
              </div>

    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <div>
              <form method="POST" action="<?php echo base_url('Admin/proses_tambah_tarif') ?>" enctype="multipart/form-data">
            ...
            <div>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('Admin/lihat_permohonan_f') ?>"><button type="button" class="btn btn-danger">Cancel</button></a>
              </div>
              </form>
            </div>

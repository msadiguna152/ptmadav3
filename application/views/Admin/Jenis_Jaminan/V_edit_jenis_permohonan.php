          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <form method="POST" action="<?php echo base_url('Admin/proses_edit_jenis_permohonan') ?>" enctype="multipart/form-data">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="exampleFormControlSelect1" name="jns">
                        <option></option>
                        <?php if ($dt['jenis'] == 1) { ?>

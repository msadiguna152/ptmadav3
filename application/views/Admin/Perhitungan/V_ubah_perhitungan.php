        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form method="POST" action="<?php echo base_url('Admin/proses_edit_perhitungan/' . $perhit['kd_jenis']) ?>" enctype="multipart/form-data">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td> <button type="submit" class="btn btn-primary" style="margin-right: 20px;">Submit</button><a href="<?php echo base_url('Admin/lihat_perhitungan/') ?>"><button type="button" class="btn btn-danger">Cancel</button></a></td>
                                    <td> </td>
                                </tr>
                            </table>
                        </form>

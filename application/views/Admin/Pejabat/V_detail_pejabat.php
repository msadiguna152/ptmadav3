<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php base_url() ?>/Admin/Admin/lihat_pejabat">Pejabat</a></li>
          ...
          <div class="tab-content">
            <div class="active tab-pane" id="profilpejabat">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                  <?php echo $data['nama_pejabat'] ?><br>
                </p>

                <!-- <strong><i class="fa fa-id-card mr-1"></i> NIP</strong>
                ...
                <a href="<?php echo site_url('Admin/edit_pejabat/' . $data['kd_pejabat']); ?>"><button class="btn btn-success"><i class="fa fa-edit"></i> Edit</button></a>
              </div>

          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <form method="POST" action="<?php echo base_url('Admin/proses_tambah_pejabat') ?>" enctype="multipart/form-data">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="no_telp" class="form-control" placeholder="Nomor Telpon" autocomplete="off">
                    </div>

              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <center>
                        <!-- <a href="<?php echo site_url('Admin/detail_permohonan_f/' . $dt['id_permohonan']); ?>" title="Detail"><i class="fa fa-eye"></i></a>| -->
                        <!-- <a href="<?php echo site_url('Admin/tarif_permohonan/' . $dt['id_permohonan']); ?>" title="Tarif"><i class="fa fa-print"></i></a> -->
                        <a href="<?php echo site_url('Admin/tambah_tarif/' . $dt['id_permohonan']); ?>" title="Buat Tarif"><i class="fa fa-edit"></i></a>

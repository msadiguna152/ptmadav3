      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-footer">
            <a href="<?php echo base_url('Admin/tambah_umum/') ?>"><button type="button" class="btn btn-info" title="Tambah Data Transaksi Umum"><i class="fa fa-plus-square"></i> Tambah Transaksi Umum</button></a>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="row">
              <div class="col-md-8">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <form id="form-filter" class="form-horizontal" method="POST" action="<?php echo base_url('Admin/cetak_umum') ?>">

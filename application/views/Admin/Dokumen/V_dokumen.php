      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Data Dokumen Pendukung</h3><br>
          </div>
          <div class="box-footer">
            <a href="<?php echo base_url('Admin/tambah_dokumen') ?>"><button type="button" class="btn btn-info" title="Tambah Data Dokumen"><i class="fa fa-plus-square"></i> Tambah Dokumen</button></a>
          </div>
          <!-- /.box-header -->
          <div class="box-body">

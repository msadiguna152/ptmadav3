      ...
      <div class="col-xs-12">
        ...
        <div class="box">
          ...
          <div class="box-footer">
            ...
            <!--  <a href="<?php echo base_url('Admin/cetak_Transaksi Permohonan') ?>"><button type="button" class="btn btn-info" title="Tambah Data Transaksi Permohonan"><i class="fa fa-plus-square"></i> Cetak</button></a> -->
          </div>
          <!-- /.box-header -->
          <div class="box-body">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <center>
                        <a href="<?php echo site_url('Admin/detail_permohonan_f/' . $dt['id_permohonan'].'/detail'); ?>" title="Detail"><i class="fa fa-edit"></i></a>
                      </center>
                    </td>
                  </tr>
                <?php

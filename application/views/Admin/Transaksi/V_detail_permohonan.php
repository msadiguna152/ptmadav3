              ...
              <div class="row">
                <div class="col-xs-6">
                  ...
                  <?php if ($status_pemasukan == 0) { ?>
                    <a href="<?php echo base_url('Admin/tambah_pemasukan/' . $dt['id_permohonan']) ?>" class="btn btn-primary " title="Tambah Data Pemasukan"><i class="fa fa-plus"></i> Tambah Pemasukan</a>
                  <?php } ?>
                </div>
                <div class="col-xs-6">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo site_url('Admin/edit_pemasukan/' . $td['id_pembayaran']); ?>" title="Edit"><i class="fa fa-edit"></i></a>
                        |
                        <a href="<?php echo site_url('Admin/hapus_pemasukan/' . $td['id_pembayaran'] . '/' . $td['id_permohonan']); ?>" onclick="return konformasi()" title="Hapus"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                  <?php
                  }
              ...
              <div class="row">
                <div class="col-xs-6">
                  ...
                  <?php if ($status_pengeluaran == 0) { ?>
                    <a href="<?php echo base_url('Admin/tambah_pengeluaran/' . $dt['id_permohonan']) ?>" class="btn btn-primary " title="Tambah Data Pengeluaran"><i class="fa fa-plus"></i> Tambah Pengeluaran</a>
                  <?php } ?>
                </div>
                <div class="col-xs-6">
                  <table class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo site_url('Admin/edit_pengeluaran/' . $td['id_pembayaran']); ?>" title="Edit"><i class="fa fa-edit"></i></a>
                        |
                        <a href="<?php echo site_url('Admin/hapus_pengeluaran/' . $td['id_pembayaran'] . '/' . $td['id_permohonan']); ?>" onclick="return konformasi()" title="Hapus"><i class="fa fa-trash"></i></a>
                      </td>
